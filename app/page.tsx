            ...
            <div className='flex space-x-4'>
              <div className='bg-cardcolor p-4 border-2 bg-opacity-80 border-buttoncolor rounded-3xl shadow-lg w-[550px] h-[320px]'>
                <div className='justify-between items-center'>
                  <div className='flex space-x-4'>
                    <button className='text-greytext text-sm px-2 py-2 font-sans'>Detect Language</button>
                    <button className='text-buttontitle text-sm font-sans px-4 py-2 rounded-lg bg-buttoncolor'>English</button>
                    <button className='text-greytext text-sm px-2 py-2 font-sans'>French</button>
                    <button className='text-greytext text-sm py-2 font-sans'>Spanish</button>
                    <button className=''>
                  ...
                  {/* Text */}
                  <div className='relative p-4 rounded-lg text-lg h-40 text-titlecolor font-sans'>Hello, how are you?</div>
                  ...
                  <div className='flex space-x-4 mt-4'>
                    ...
                    <button className=' absolute left-60 flex  rounded-2xl border-2 border-buttonborder bg-translatecolor px-6 py-2 font-sans text-titlecolor text-lg'>
            ...
            <div className='flex space-x-4'>
              <div className='bg-cardcolor2 p-4 border-2 bg-opacity-90 border-buttoncolor rounded-3xl shadow-lg w-[550px] h-[320px]'>
                ...
                <div className='flex justify-between items-center'>
                  <div className='flex space-x-4'>
                    <button className='text-gray-400 text-sm px-2 font-sans'>English</button>
                    <button className='text-buttontitle text-sm font-sans px-4 py-2 rounded-lg bg-buttoncolor'>French</button>
                    <button className='text-gray-400 text-sm px-1 py-2 font-sans'>Spanish </button>
                    <button>
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 6L8 10L4 6" stroke="#6C727F" strokeWidth="2"/>
                      </svg>
                  ...
                  <button className='text-gray-400 border-2 border-buttoncolor rounded-xl p-1'>
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
